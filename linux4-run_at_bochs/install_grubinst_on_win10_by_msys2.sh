...
sshpass -p $ubt22x64Pass scp  -o ConnectTimeout=$SshConnTimeoutSeconds -o StrictHostKeyChecking=no -P $ubt22LocPort  $ubt22x64User@u22.loc:/crk/bochs/linux2.6-run_at_bochs/$HdImgF /$HdImgF && \
...
sshpass -p $ubt22x64Pass scp  -o ConnectTimeout=$SshConnTimeoutSeconds  -o StrictHostKeyChecking=no -P $ubt22LocPort  /$HdImgF  $ubt22x64User@u22.loc:/crk/bochs/linux2.6-run_at_bochs/$HdImgF  && \
