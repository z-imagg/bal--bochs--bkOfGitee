...
000001f4 <mount_block_root>:                                             #0. 此即  mount_block_root == 0X1f4
 1f4:	55                   	push   %ebp
 ...
 32b:	e8 fc ff ff ff       	call   32c <mount_block_root+0x138>      #2.  仔细看此行  mount_block_root+0x138 == 0X32c, 跳转 的 目的地址 0X32C 并不是某指令的开头 此即 跳转到非法指令，因此崩溃。  (备注 地址0X32C 附近 只有 地址 0x32b 、 地址0x330 是指令开头）
...
000003a5 <mount_root>:                                       #0. 此即  mount_root == 0X3a5
 3a5:	55                   	push   %ebp
 ...
 491:	e8 fc ff ff ff       	call   492 <mount_root+0xed> #2. mount_root+0xed == 0x492, 跳转 的 目的地址 0x492 并不是某指令的开头 此即 跳转到非法指令，因此崩溃。  (备注 地址 0x492 附近 只有 地址 0x491 、 地址0x496 是指令开头）
