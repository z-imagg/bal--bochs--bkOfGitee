...
sshpass -p $ubt22x64Pass scp  -o ConnectTimeout=$SshConnTimeoutSeconds -o StrictHostKeyChecking=no -P $ubt22x64Port  $ubt22x64User@ubt22x64Host:/crk/bochs/linux2.6-run_at_bochs/$HdImgF /$HdImgF && \
...
sshpass -p $ubt22x64Pass scp  -o ConnectTimeout=$SshConnTimeoutSeconds  -o StrictHostKeyChecking=no -P $ubt22x64Port  /$HdImgF  $ubt22x64User@ubt22x64Host:/crk/bochs/linux2.6-run_at_bochs/$HdImgF  && \
