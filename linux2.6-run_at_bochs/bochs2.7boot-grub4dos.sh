...
scp  -P 3022 HD10MB40C16H32S.img zzz@$win10Host:/HD10MB40C16H32S.img 
ssh -p 3022 zzz@$win10Host "/grubinst_1.0.1_bin_win/grubinst/grubinst.exe /HD10MB40C16H32S.img && echo 'grubinst.exe ok'"
scp   -P 3022  zzz@$win10Host:/HD10MB40C16H32S.img  HD10MB40C16H32S.img
